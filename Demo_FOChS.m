...
%1. Chen's system:
[t, y]=FOChen([35 3 28 -7], [0.95 0.95 0.95], 100, [-9 -5 14]);
figure
plot3(y(:,1), y(:,2), y(:,3),'k');
xlabel('x(t)'); ylabel('y(t)'); zlabel('z(t)'); title("Fractional order Chen's Chaotic System for q1=0.95 q2=0.95 q3=0.95");grid;
